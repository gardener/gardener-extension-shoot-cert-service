...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CAInjector) DeepCopyInto(out *CAInjector) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CAInjector.
func (in *CAInjector) DeepCopy() *CAInjector {
	if in == nil {
		return nil
	}
	out := new(CAInjector)
...
func (in *CertConfig) DeepCopyInto(out *CertConfig) {
	*out = *in
	...
	if in.CAInjector != nil {
		in, out := &in.CAInjector, &out.CAInjector
		*out = new(CAInjector)
		**out = **in
	}
	return
