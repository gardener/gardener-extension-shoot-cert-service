...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CAInjector)(nil), (*service.CAInjector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CAInjector_To_service_CAInjector(a.(*CAInjector), b.(*service.CAInjector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*service.CAInjector)(nil), (*CAInjector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_service_CAInjector_To_v1alpha1_CAInjector(a.(*service.CAInjector), b.(*CAInjector), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_CAInjector_To_service_CAInjector is an autogenerated conversion function.
func Convert_v1alpha1_CAInjector_To_service_CAInjector(in *CAInjector, out *service.CAInjector, s conversion.Scope) error {
	return autoConvert_v1alpha1_CAInjector_To_service_CAInjector(in, out, s)
}
...
// Convert_service_CAInjector_To_v1alpha1_CAInjector is an autogenerated conversion function.
func Convert_service_CAInjector_To_v1alpha1_CAInjector(in *service.CAInjector, out *CAInjector, s conversion.Scope) error {
	return autoConvert_service_CAInjector_To_v1alpha1_CAInjector(in, out, s)
}
...
func autoConvert_v1alpha1_CertConfig_To_service_CertConfig(in *CertConfig, out *service.CertConfig, s conversion.Scope) error {
	...
	out.CAInjector = (*service.CAInjector)(unsafe.Pointer(in.CAInjector))
	return nil
}
...
func autoConvert_service_CertConfig_To_v1alpha1_CertConfig(in *service.CertConfig, out *CertConfig, s conversion.Scope) error {
	...
	out.GenerateControlPlaneCertificate = (*bool)(unsafe.Pointer(in.GenerateControlPlaneCertificate))
	out.CAInjector = (*CAInjector)(unsafe.Pointer(in.CAInjector))
	return nil
}
