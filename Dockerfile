############# builder
FROM eu.gcr.io/gardener-project/3rd/golang:1.15.8 AS builder
...
FROM eu.gcr.io/gardener-project/3rd/alpine:3.13.2 AS gardener-extension-shoot-cert-service
