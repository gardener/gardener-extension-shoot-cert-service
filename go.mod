...
require (
	...
	github.com/gardener/controller-manager-library v0.2.1-0.20251016104111-a9eedfad962e // indirect
	github.com/gardener/etcd-druid/api v0.34.0 // indirect
	github.com/gardener/external-dns-management v0.29.0 // indirect
