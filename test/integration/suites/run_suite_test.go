...
import (
	...
	_ "github.com/gardener/gardener-extension-shoot-cert-service/test/integration/healthcheck"
...
func TestGardenerSuite(t *testing.T) {
	RunSpecsWithDefaultAndCustomReporters(t, "Shoot-certificate-service Test Suite", []Reporter{reporter.NewGardenerESReporter(*reportFilePath, *esIndex)})
}
