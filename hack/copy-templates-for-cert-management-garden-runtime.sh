...
DEST_DIR=$PROJECT_ROOT/charts/internal/cert-management-garden-runtime/templates

mkdir -p $DEST_DIR

echo "Copying templates for cert-management-garden-runtime charts"
...
cp $SEED_TEMPLATES/poddisruptionbudget.yaml $DEST_DIR
